...
// HCons(head=1000, tail=HCons(head=900, tail=arrow.generic.HNil@8d21e50))
```

```kotlin
Account(1000, 900).toHListLabeled()
// HCons(head=Tuple2(a=balance, b=1000), tail=HCons(head=Tuple2(a=available, b=900), tail=arrow.generic.HNil@8d21e50))
```
...
// DeferredK(deferred=LazyDeferredCoroutine{New}@1a9e195)
```
